...
<h3 align="center">SvelteMeet</h3>

<div align="center">

  [![Status](https://img.shields.io/badge/status-active-success.svg)]() 
  [![GitHub Issues](https://img.shields.io/github/issues/Niravanaa/SvelteMeet.svg)](https://github.com/Niravanaa/SvelteMeet/issues)
  [![GitHub Pull Requests](https://img.shields.io/github/issues-pr/Niravanaa/SvelteMeet.svg)](https://github.com/Niravanaa/SvelteMeet/pulls)
...
1. **Node.js and npm**: SvelteMeet relies on Node.js and npm for development. If not already installed, download and install them from Node.js official website.

2. **Svelte**: Svelte is the web framework used for building the frontend of SvelteMeet. Install it globally using the following command:
```bash
npm install -g svelte
```

3. **Editor (Optional)**: A code editor such as Visual Studio Code or Sublime Text is recommended for a smoother development experience. You can download Visual Studio Code from here if needed.
...
Once the development server is running, open your web browser and go to http://localhost:5000 to access SvelteMeet.

6. **Explore and Collaborate:**
You are now set up with a local development environment. Explore the features of SvelteMeet, create meetup events, and collaborate socially with other users.
...
Ensure that your repository is hosted on GitHub and navigate to the "Settings" tab. Scroll down to the "GitHub Pages" section, and under "Source," select the branch you want to deploy (usually "gh-pages").
...
Once the deployment is complete, you can access the live SvelteMeet application by visiting https://[github-username].github.io/SvelteMeet/. Share this link with others to collaborate and participate in the meetup events.
...
- [@Niravanaa](https://github.com/Niravanaa) - Idea & Initial work
